...
import CartProductsTableHead from "./CartProductsTableHead";
...
function CartProductsTable(props) {
  const {selectSelectedCart, selectCartSearchText:searchText} = useCart()
  const dispatch = useDispatch();
  const cart = selectSelectedCart()
  ...
  function handleClick(item) {
    props.navigate(`/productos/${item.id}/${item.name}`);
  }
