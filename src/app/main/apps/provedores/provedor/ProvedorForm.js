...
import TaskPrioritySelector from './ProvedorPrioritySelector';
...
const TaskForm = (props) => {
  ...
  function onSubmitNew(data) {
    dispatch(addTask(data)).then(({ payload }) => {
      navigate(`/apps/provedores/${payload.id}`);
    });
  }
      ...
      <div className="relative flex flex-col flex-auto items-center px-24 sm:px-48">
        <div className="flex items-center justify-between border-b-1 w-full py-24 mt-16 mb-32">
          ...
          <div className="flex items-center">
            ...
            <IconButton className="" component={NavLinkAdapter} to="/apps/provedores" size="large">
